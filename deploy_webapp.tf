resource "null_resource" "create-inventory" {
  ...
  provisioner "local-exec" {
    #command = "ls -ltr"
    command = "sh /home/mail2maham/demo1/ansible//home/mail2maham/demo1/ansible; echo ${oci_core_instance.this.*.public_ip[0]} >> /home/mail2maham/demo1/ansible/tf_inventory.yaml; echo ${oci_core_instance.this.*.public_ip[1]} >> /home/mail2maham/demo1/ansible/tf_inventory.yaml"
  }
}
...
resource "null_resource" "run-ansible-playbook" {
  ...
  # Create inventory
  provisioner "local-exec" {
    command = "sh /home/mail2maham/demo1/ansible/my-playbook.sh"
  }
}
